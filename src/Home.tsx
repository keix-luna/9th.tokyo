  ...
  return (
    ...
    <div className="right main-contents">
      ...
      <div className="contents">
        ...
        The project is led by <a href="https://keix.github.io">@Kei Sawamura</a>, who provided guidance and oversight throughout the development process. Most of the design and implementation were <span className="emphasis">generated by AI systems</span>. While the app features a robust and forward-thinking architecture powered by cutting-edge technology, it is not intended for practical use. Instead, 9th.tokyo serves as a parody or homage to the portrayal of highly advanced, emotion-bearing AI systems often depicted in popular anime.
        </div>
