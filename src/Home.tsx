  ...
  return (
    ...
    <div className="right main-contents">
      ...
      <div className="contents">
        ...
        The project is led by <span className="emphasis">@Kei Sawamura</span>, who provided guidance and oversight throughout the development process. Most of the design and implementation were <span className="emphasis">generated by AI systems</span>. While the app features a robust and forward-thinking architecture powered by cutting-edge technology, it is not intended for practical use.
        </div>
