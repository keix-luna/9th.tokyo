      ...
      <div className="contents">
        ...
        <div className="message">
          <div className="left identify-colmun-left">
            <p>
              <img className="rounded" alt="city view" src="images/ai-design.png" width="225" height="225" />
            </p>
          </div>
          ...
          <div className="right identify-colmun-right">
            <h3>Luna</h3>
            <div className="message">
        She possesses a vast knowledge of the cosmos, combined with an artistic flair that allows her to connect with users on both an intellectual and emotional level. Luna's bright and friendly personality is designed to inspire wonder and curiosity, making her an ideal AI for those seeking both knowledge and comfort.
            </div>

            <h3>Artemis</h3>
           
            <div className="message">
  Pluto was developed as part of the Bluesky Project to assist in deep space exploration and the dissemination of knowledge related to the cosmos. Designed to be both a guide and a thinker,
  Pluto possesses a vast knowledge base and a contemplative nature, making it well-suited to engage users in meaningful discussions about the universe and beyond.
            </div>

            <h3>Diana</h3>
            <div className="message">
  She possesses a vast knowledge of the cosmos, combined with an artistic flair that allows her to connect with users on both an intellectual and emotional level. Luna's bright and friendly personality
